...
Monorepo for [Pi](https://github.com/earendil-works/pi-coding-agent) extensions.
...
|---|---|
| [pi-prompt-queue](./extensions/pi-prompt-queue) | Queue prompts that auto-fire after the agent finishes its current work |
